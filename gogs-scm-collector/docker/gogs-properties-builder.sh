...
then
	...
	PROP_FILE=hygieia-gogs-scm-collector.properties
fi
...
gogs.cron=${GOGS_CRON:-0 0/5 * * * *}

#gogs.host=${GOGS_HOST:-try.gogs.io}

#Maximum number of days to go back in time when fetching commits
gogs.commitThresholdDays=${GOGS_COMMIT_THRESHOLD_DAYS:-15}
